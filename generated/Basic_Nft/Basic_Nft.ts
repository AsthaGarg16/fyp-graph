...
export class Basic_Nft extends ethereum.SmartContract {
  static bind(address: Address): Basic_Nft {
    return new Basic_Nft("Basic_Nft", address);
  }
  ...
  id_to_assetURI(param0: BigInt): string {
    let result = super.call(
      "id_to_assetURI",
      "id_to_assetURI(uint256):(string)",
  ...
  try_id_to_assetURI(param0: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "id_to_assetURI",
      "id_to_assetURI(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  id_to_metadataURI(param0: BigInt): string {
    let result = super.call(
      "id_to_metadataURI",
      "id_to_metadataURI(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_id_to_metadataURI(param0: BigInt): ethereum.CallResult<string> {
    let result = super.tryCall(
      "id_to_metadataURI",
      "id_to_metadataURI(uint256):(string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  metadataURI(tokenId: BigInt): string {
  ...
  try_metadataURI(tokenId: BigInt): ethereum.CallResult<string> {
